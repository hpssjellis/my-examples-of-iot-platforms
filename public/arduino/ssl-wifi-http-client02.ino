...
unsigned long myMillisSecondDelay = 30000;   // 30000 = 30 seconds
...
// https://io.adafruit.com/api/v2/webhooks/feed/aaaaaaaaa-your-webhook-aaaaaaaaaaaaaaa

String myAdafruitWebhook = "/api/v2/webhooks/feed/aaaaaaaaa-your-webhook-aaaaaaaaaaaaaaa";
String myData = "value=234";  // might be changed later to read A0
...
*/
  ...
  if (millis() - lastMillis > myMillisSecondDelay) {
    ...
    if (client.connect(server, 443)) {
       ...
       myData = "value=" + String(analogRead(A0));
